...
def write_report_and_page(
    ...
    page_path.write_text(
        pulse_html.render_html(report, overview_href="../index.html", bills_href="../bills/index.html"),
        encoding="utf-8",
    )
    return {
        "report": report,
...
<body>
  <div class="shell">
    <header>
      <div>
        <nav class="page-nav"><a href="bills/index.html">Gesetze verfolgen</a></nav>
...
def main() -> int:
    ...
    index_path.write_text(
        render_overview(protocols, entries, catalog_path, bill_count=int(bill_output["count"])),
        encoding="utf-8",
    )
    print(index_path)
    return 0
